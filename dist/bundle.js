...
exports.Element = exports.DragOn = undefined;
...
var DragOn = exports.DragOn = function () {
	function DragOn(element) {
		...
		(0, _jquery2.default)(element).on('mousedown', function (e) {

			_this.cursor.down = true;

			// reset cursor history
			_this.cursor.history = [];

			_this.cursor.posY = e.pageY;
			_this.cursor.posX = e.pageX;
		...
		(0, _jquery2.default)(element).on('mouseup', function (e) {

			_this.cursor.down = false;

			// average deltas	
			var h = _this.cursor.history;
			...
			var avgDelta = function avgDelta(a) {
				var t = 0;
		...
		(0, _jquery2.default)(element).on('mousemove', function (e) {

			if (!_this.cursor.down) {
				return;
			};

			_this.cursor.history.unshift({ x: _this.cursor.posX, y: _this.cursor.posY });

			if (_this.cursor.history.length > 3) {
				_this.cursor.history.pop();
			};
	...
	_createClass(DragOn, [{
		...
		value: function getCenter() {
			...
			var x = (0, _jquery2.default)(this.el).scrollLeft() + (0, _jquery2.default)(this.el).width() / 2;
			var y = (0, _jquery2.default)(this.el).scrollTop() + (0, _jquery2.default)(this.el).height() / 2;

			return { x: x, y: y };
		}
	}, {
		key: 'getDistanceTo',
		value: function getDistanceTo(r) {

			var rPos = r.getCenter();
			var cPos = this.getCenter();

			var dist = Math.sqrt(Math.pow(rPos.x - cPos.x, 2) + Math.pow(rPos.y - cPos.y, 2));
	...
	function Resource(data, z, parent) {
		...
		switch (_this.data.type) {
			...
			case 'image':
				...
				$content = (0, _jquery2.default)('<img>').attr('src', _this.data.content).addClass('content');
...
(0, _jquery2.default)(document).ready(function () {
	...
	(0, _jquery2.default)(window).scroll(function (e) {
		...
		var scrollTop = (0, _jquery2.default)(e.currentTarget).scrollTop();

		if (scrollTop > 0) {
			(0, _jquery2.default)('nav').attr('id', 'white-nav');
		} else {
			(0, _jquery2.default)('nav').attr('id', '');
		}
...
function playMenu() {
	...
	var $button = (0, _jquery2.default)("#section1 .button");
	_gsap2.default.from($button, .7, {
		opacity: 0,
		display: "none",
		marginTop: "20vh",
		ease: Power1.easeInOut,
	...
	_gsap2.default.from($logo, .5, {
		opacity: 0,
		ease: Power1.easeInOut,
		delay: .2
	});
	for (var i = 3; i > 0; i--) {
		var $a = (0, _jquery2.default)('nav>div>a:nth-child(' + i + ')');
		_gsap2.default.from($a, .5, {
			opacity: "0",
			delay: .1 * i + .3
		});
	};
...
function playIntro() {
	...
	_gsap2.default.to((0, _jquery2.default)('#section2>div'), 14, {
		marginLeft: "46vw",
...
var Cloud = {
	...
	init: function init() {
		...
		Cloud.getResources(function (r) {
			...
			for (var _i = 0; _i < len; _i++) {
				...
				var cat = Cloud.categories[res.category];

				if (!cat) {

					_this.categories[r[_i].category] = new _Resource.Category(r[_i].category, catColors[r[_i].category]);
			...
			function imageLoaded() {
				...
				var p = counter * 100 / images.length;

				_gsap2.default.to((0, _jquery2.default)('#loadBar'), 0.1, { width: 100 - p + '%' });

				if (counter === 0) {

					(0, _jquery2.default)('#loadBar').slideUp();
					var _len = Cloud.resources.length;

					var _loop = function _loop() {

						var r = Cloud.resources[i];

						setTimeout(function () {
							_gsap2.default.to((0, _jquery2.default)('#loader'), 1, { opacity: 0 });
			...
			(0, _jquery2.default)('#loadBar').slideDown();

			images.each(function () {
				if (this.complete) {
					imageLoaded.call(this);
				} else {
					(0, _jquery2.default)(this).one('load', imageLoaded);
				}
			});
	...
	storeResources: function storeResources() {
		var len = Cloud.vue.resources.length;
		for (var i = 0; i < len; i++) {
	...
	getClosestCategory: function getClosestCategory() {
		...
		for (var name in this.categories) {
			...
			if (!cat || !cat.entryPoint) {
				continue;
			};

			var dist = Cloud.drag.getDistanceTo(cat.entryPoint);
			if (dist < lowest) {
				lowest = dist;
				r = cat;
			}
	...
	animate: function animate() {
		...
		var closest = Cloud.getClosestCategory();
